...
public class ItemZeroOne extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemZeroOne(ToolMaterial kingdomkeylk) {
        super(kingdomkeylk);
        this.setCreativeTab(KingdomKeys.KHRECODEDTAB);
    }
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List dataList, boolean bool){
    	dataList.add("Kingdom Hearts Re:Coded");
    }

...
public class ItemOneWingedAngel extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemOneWingedAngel(ToolMaterial kingdomkey8888) {
        super(kingdomkey8888);

...
public class ItemLeopardos extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemLeopardos(ToolMaterial kingdomkeys) {
        super(kingdomkeys);
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List dataList, boolean bool){
    	dataList.add("Kingdom Hearts Chi");
    }
    ...
    {
    itemstack.addEnchantment(KingdomKeys.HarvestHearts, 5);
    }

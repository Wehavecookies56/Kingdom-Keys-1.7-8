...
public class AddedItems {
	...
	public static void initKeyBlades(){
		...
		K66m = EnumHelperClient.addToolMaterial(Strings.Fatalcrest, 3, -1, 6.0F, 10, 30); K66 = new ItemFatalCrest(K66m).setFull3D().setUnlocalizedName(Strings.Fatalcrest); GameRegistry.registerItem(K66, Strings.Fatalcrest);
		K67m = EnumHelperClient.addToolMaterial(Strings.Twobecomesone, 3, -1, 6.0F, 10, 30); K67 = new ItemTwoBecomeOne(K67m).setFull3D().setUnlocalizedName(Strings.Twobecomesone); GameRegistry.registerItem(K67, Strings.Twobecomesone);
		K68m = EnumHelperClient.addToolMaterial(Strings.Bondofflame, 3, -1, 6.0F, 9, 30); K68 = new ItemBondOfFlame(K68m).setFull3D().setUnlocalizedName(Strings.Bondofflame); GameRegistry.registerItem(K68, Strings.Bondofflame);
		K69m = EnumHelperClient.addToolMaterial(Strings.Fenrir, 3, -1, 6.0F, 7, 30); K69 = new ItemFenrir(K69m).setFull3D().setUnlocalizedName(Strings.Fenrir); GameRegistry.registerItem(K69, Strings.Fenrir);
		K70m = EnumHelperClient.addToolMaterial(Strings.Sleepinglion, 3, -1, 6.0F, 7, 30); K70 = new ItemSleepingLion(K70m).setFull3D().setUnlocalizedName(Strings.Sleepinglion); GameRegistry.registerItem(K70, Strings.Sleepinglion);
		...
		K76m = EnumHelperClient.addToolMaterial(Strings.Decisivepumpkin, 3, -1, 6.0F, 9, 30); K76 = new ItemDecisivePumpkin(K76m).setFull3D().setUnlocalizedName(Strings.Decisivepumpkin); GameRegistry.registerItem(K76, Strings.Decisivepumpkin);
		...
		K82m = EnumHelperClient.addToolMaterial(Strings.Rumblingrose, 3, -1, 6.0F, 7, 30); K82 = new ItemRumblingRose(K82m).setFull3D().setUnlocalizedName(Strings.Rumblingrose); GameRegistry.registerItem(K82, Strings.Rumblingrose);

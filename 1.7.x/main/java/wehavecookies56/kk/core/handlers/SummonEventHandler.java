...
public class SummonEventHandler {
	...
	public static void handlePacket(Packet250CustomPayload packet, EntityPlayer player) {
		...
		if(i2 == 0 && i1 != 0){
			if(player.inventory.hasItem(i1)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i3 == 0 && i2 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i4 == 0 && i3 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i5 == 0 && i4 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i6 == 0 && i5 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				player.inventory.consumeInventoryItem(i5);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i7 == 0 && i6 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				player.inventory.consumeInventoryItem(i5);
				player.inventory.consumeInventoryItem(i6);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i8 == 0 && i7 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6) && player.inventory.hasItem(i7)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				player.inventory.consumeInventoryItem(i5);
				player.inventory.consumeInventoryItem(i6);
				player.inventory.consumeInventoryItem(i7);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i9 == 0 && i8 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6) && player.inventory.hasItem(i7) && player.inventory.hasItem(i8)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				...
				player.inventory.consumeInventoryItem(i6);
				player.inventory.consumeInventoryItem(i7);
				player.inventory.consumeInventoryItem(i8);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i10 == 0 && i9 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6) && player.inventory.hasItem(i7) && player.inventory.hasItem(i8) && player.inventory.hasItem(i9)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				...
				player.inventory.consumeInventoryItem(i7);
				player.inventory.consumeInventoryItem(i8);
				player.inventory.consumeInventoryItem(i9);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i11 == 0 && i10 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6) && player.inventory.hasItem(i7) && player.inventory.hasItem(i8) && player.inventory.hasItem(i9) && player.inventory.hasItem(i10)){
				player.inventory.consumeInventoryItem(i1);
				player.inventory.consumeInventoryItem(i2);
				player.inventory.consumeInventoryItem(i3);
				player.inventory.consumeInventoryItem(i4);
				...
				player.inventory.consumeInventoryItem(i8);
				player.inventory.consumeInventoryItem(i9);
				player.inventory.consumeInventoryItem(i10);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}else if(i11 != 0){
			if(player.inventory.hasItem(i1) && player.inventory.hasItem(i2) && player.inventory.hasItem(i3) && player.inventory.hasItem(i4) && player.inventory.hasItem(i5) && player.inventory.hasItem(i6) && player.inventory.hasItem(i7) && player.inventory.hasItem(i8) && player.inventory.hasItem(i9) && player.inventory.hasItem(i10)){
				...
				player.inventory.consumeInventoryItem(i9);
				player.inventory.consumeInventoryItem(i10);
				player.inventory.consumeInventoryItem(i11);
				player.inventory.addItemStackToInventory(new ItemStack(UsefulArrays.keychain[ri], 1));
			}
		}

		
		DataInputStream disgui = new DataInputStream(new ByteArrayInputStream(packet.data));
		try
		{
			MPp = disgui.readFloat();
			MPm = disgui.readFloat();
		...
		mpPercent = (MP * 100.0f) / 100;
		barPercent = (mpPercent / 100.0f) * 102;

...
public class ItemXehanortsKeyblade extends ItemSword implements IBattlegearWeapon {
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemXehanortsKeyblade(ToolMaterial kingdomkeycxz) {
        super(kingdomkeycxz);
    ...
    {
    itemstack.addEnchantment(KingdomKeys.HarvestHearts, 10);
    }

...
public class ItemMysteriousAbyss extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemMysteriousAbyss(ToolMaterial kingdomkey5555) {
        super(kingdomkey5555);

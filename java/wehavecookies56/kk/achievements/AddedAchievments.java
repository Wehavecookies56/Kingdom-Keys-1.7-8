...
public class AddedAchievments {
	...
	public static void initAchievements(){
		...
		AchievementPage.registerAchievementPage(kingdomKeysAchievement = new AchievementPage("Kingdom Keys", new Achievement[]{bugBlox, recipe, kingdomKey, orichalcum, orichalcumPlus, munny, hp, kkpotion, synthesizer, menu}));
	}

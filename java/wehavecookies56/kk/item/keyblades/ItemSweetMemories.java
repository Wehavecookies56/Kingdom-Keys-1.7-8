...
public class ItemSweetMemories extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemSweetMemories(ToolMaterial kingdomkey98765) {
        super(kingdomkey98765);

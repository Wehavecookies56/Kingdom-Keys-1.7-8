...
public class ItemChaosRipper extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemChaosRipper(ToolMaterial chaosRipperMaterial) {
        super(chaosRipperMaterial);

...
public class ItemAstralBlast extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemAstralBlast(ToolMaterial astralBlastMaterial) {
        super(astralBlastMaterial);

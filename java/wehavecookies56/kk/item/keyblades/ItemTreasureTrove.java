...
public class ItemTreasureTrove extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemTreasureTrove(ToolMaterial kingdomkey987654321) {
        super(kingdomkey987654321);

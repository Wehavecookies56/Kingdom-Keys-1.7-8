...
public class ItemOathKeeper extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemOathKeeper(ToolMaterial oathkeeperMaterial) {
        super(oathkeeperMaterial);

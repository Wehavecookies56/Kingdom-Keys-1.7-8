...
public class ItemAbyssalTide extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemAbyssalTide(ToolMaterial abyssalTideMaterial) {
        super(abyssalTideMaterial);

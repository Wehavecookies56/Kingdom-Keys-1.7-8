...
public class ItemSleepingLion extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemSleepingLion(ToolMaterial kingdomkey123456) {
        super(kingdomkey123456);

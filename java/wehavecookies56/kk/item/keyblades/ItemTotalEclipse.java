...
public class ItemTotalEclipse extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemTotalEclipse(ToolMaterial kingdomkey98765432) {
        super(kingdomkey98765432);

...
public class ItemSpellbinder extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemSpellbinder(ToolMaterial kingdomkey1234567) {
        super(kingdomkey1234567);

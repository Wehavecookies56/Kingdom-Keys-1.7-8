...
public class ItemBrightCrest extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemBrightCrest(ToolMaterial brightCresMaterial) {
        super(brightCresMaterial);

...
public class ItemPhotonDebugger extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemPhotonDebugger(ToolMaterial kingdomkey9999) {
        super(kingdomkey9999);

...
public class ItemYoungXehanort extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemYoungXehanort(ToolMaterial kingdomkeynm) {
        super(kingdomkeynm);
    ...
    {
    itemstack.addEnchantment(KingdomKeys.HarvestHearts, 8);
    }

...
public class ItemStormFall extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemStormFall(ToolMaterial kingdomkey123456789) {
        super(kingdomkey123456789);

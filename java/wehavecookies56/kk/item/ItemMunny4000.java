...
public class ItemMunny4000 extends ItemKingdomKeys{

    public ItemMunny4000() {
        super();       
        this.setUnlocalizedName(Strings.Munny4000); 
    }
    
    @Override
	public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer entity) {
			IMessage packet = new MunnyPacket(new ItemStack(AddedItems.Munny4000), 4000);

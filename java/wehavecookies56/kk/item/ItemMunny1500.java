...
public class ItemMunny1500 extends ItemKingdomKeys{

    public ItemMunny1500() {
        super();       
        this.setUnlocalizedName(Strings.Munny1500); 
    }
    
    @Override
	public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer entity) {
			IMessage packet = new MunnyPacket(new ItemStack(AddedItems.Munny1500), 1500);

...
public class EntityRenderEternalFlames extends Render
{
	
	private final ResourceLocation texture = new ResourceLocation("kk", "textures/items/EternalFlames.png");
	@SideOnly(Side.CLIENT)
    public void renderArrow(EntityEternalFlames par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderArrow((EntityEternalFlames)par1Entity, par2, par4, par6, par8, par9);
    }

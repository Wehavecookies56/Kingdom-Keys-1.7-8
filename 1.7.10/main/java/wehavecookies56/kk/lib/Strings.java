...
public class Strings {
	...
	public static final String Appregio = "apreggio";
    ...
    public static final String Munny20 = "20Munny";
	...
	public static final String UnicornisRecipe = "unicornisForetellersKeybladeRecipe";
	public static final String LeopardosRecipe = "leopardosForetellersKeybladeRecipe";
	public static final String AnguisRecipe = "anguisForetellersKeybladeRecipe";
	public static final String LeaskeybladeRecipe = "leasKeybladeRecipe";
	public static final String YoungxehanortskeybladeRecipe = "youngXehanortsKeybladeRecipe";
	public static final String OceanrageRecipe = "oceanRageRecipe";
	public static final String EndofpainRecipe = "endofPainRecipe";
	public static final String UnboundRecipe = "unboundRecipe";
	public static final String SweetdreamsRecipe = "sweetDreamsRecipe";
	public static final String DivewingRecipe = "divewingRecipe";
	public static final String CounterpointRecipe = "counterpointRecipe";
	public static final String AllforoneRecipe = "allforOneRecipe";
	public static final String KnockoutpunchRecipe = "knockoutPunchRecipe";
	public static final String FerrisgearRecipe = "ferrisGearRecipe";
	public static final String DualdiscRecipe = "dualDiscRecipe";
	public static final String GuardianbellRecipe = "guardianBellRecipe";
	public static final String SkullnoiseRecipe = "skullNoiseRecipe";
	public static final String WoodenkeybladeRecipe = "woodenKeybladeRecipe";
	public static final String KyebladebrokenRecipe = "incompletekyebladeRecipe";
	public static final String KyebladeRecipe = "kyebladeRecipe";
	public static final String LightseekerRecipe = "lightSeekerRecipe";
	public static final String LostmemoryRecipe = "lostMemoryRecipe";
	public static final String FrolicflameRecipe = "frolicFlameRecipe";
	public static final String MasterkeeperRecipe = "masterKeeperRecipe";
	public static final String BrigthcrestRecipe = "brightcrestRecipe";
	public static final String CrownunlimitRecipe = "crownUnlimitRecipe";
	public static final String NonameRecipe = "noNameRecipe";
	public static final String VoidgearRecipe = "voidGearRecipe";
	public static final String SweetstackRecipe = "sweetstackRecipe";
	public static final String PixiepetalRecipe = "pixiePetalRecipe";
	public static final String HyperdriveRecipe = "hyperdriveRecipe";
	public static final String MarkofaheroRecipe = "markofaHeroRecipe";
	public static final String VictorylineRecipe = "victoryLineRecipe";
	public static final String FairystarsRecipe = "fairyStarsRecipe";
	public static final String StrokeofmidnightRecipe = "strokeofMidnightRecipe";
	public static final String ChaosripperRecipe = "chaosRipperRecipe";
	public static final String XehanortskeybladeRecipe = "masterXehanortsKeybladeRecipe";
	public static final String DarkgnawRecipe = "darkgnawRecipe";
	public static final String ZerooneRecipe = "zeroOneRecipe";
	public static final String DreamswordRecipe = "dreamSwordRecipe";
	public static final String AubadeRecipe = "aubadeRecipe";
	public static final String UmbrellaRecipe = "umbrellaRecipe";
	public static final String OmegaweaponRecipe = "omegaWeaponRecipe";
	public static final String TwilightblazeRecipe = "twilightBlazeRecipe";
	public static final String MaverickflareRecipe = "maverickFlareRecipe";
	public static final String AstralblastRecipe = "astralBlastRecipe";
	public static final String DarkerthandarkRecipe = "darkerThanDarkRecipe";
	public static final String LunareclipseRecipe = "lunarEclipseRecipe";
	public static final String SilentdirgeRecipe = "silentDirgeRecipe";
	public static final String TotaleclipseRecipe = "totalEclipseRecipe";
	public static final String GlimpseofdarknessRecipe = "glimpseofDarknessRecipe";
	public static final String MidnightroarRecipe = "midnightRoarRecipe";
	public static final String RejectionoffateRecipe = "rejectionofFateRecipe";
	public static final String TruelightsflightRecipe = "trueLightsFlightRecipe";
	public static final String LeviathanRecipe = "leviathanRecipe";
	public static final String AbyssaltideRecipe = "abyssalTideRecipe";
	public static final String CrownofguiltRecipe = "crownofGuiltRecipe";
	public static final String SignofinnocenceRecipe = "signofInnocenceRecipe";
	public static final String PainofsolitudeRecipe = "painofSolitudeRecipe";
	public static final String AbbadonplasmaRecipe = "abaddonPlasmaRecipe";
	public static final String OminousblightRecipe = "ominousBlightRecipe";
	public static final String MissingacheRecipe = "missingAcheRecipe";
	public static final String WinnersproofRecipe = "winnersProofRecipe";
	public static final String FatalcrestRecipe = "fatalCrestRecipe";
	public static final String TwobecomesoneRecipe = "twoBecomeOneRecipe";
	public static final String BondofflameRecipe = "bondofFlameRecipe";
	public static final String FenrirRecipe = "fenrirRecipe";
	public static final String SleepinglionRecipe = "sleepingLionRecipe";
	public static final String GuardiansoulRecipe = "guardianSoulRecipe";
	public static final String GullwingRecipe = "gullWingRecipe";
	public static final String PhotondebuggerRecipe = "photonDebuggerRecipe";
	public static final String SweetmemoriesRecipe = "sweetMemoriesRecipe";
	public static final String CircleoflifeRecipe = "circleofLifeRecipe";
	public static final String DecisivepumpkinRecipe = "decisivePumpkinRecipe";
	public static final String WishinglampRecipe = "wishingLampRecipe";
	public static final String FollowthewindRecipe = "followtheWindRecipe";
	public static final String MysteriousabyssRecipe = "mysteriousAbyssRecipe";
	public static final String MonochromeRecipe = "monochromeRecipe";
	public static final String HeroscrestRecipe = "herosCrestRecipe";
	public static final String RumblingroseRecipe = "rumblingRoseRecipe";
	public static final String HiddendragonRecipe = "hiddenDragonRecipe";
	public static final String EndsofearthRecipe = "endsoftheEarthRecipe";
	public static final String StormfallRecipe = "stormfallRecipe";
	public static final String DestinysembraceRecipe = "destinysEmbraceRecipe";
	public static final String WaytodawnRecipe = "waytotheDawnRecipe";
	public static final String OnewingedangelRecipe = "oneWingedAngelRecipe";
	public static final String DiamonddustRecipe = "diamondDustRecipe";
	public static final String LionheartRecipe = "lionheartRecipe";
	public static final String MetalchocoboRecipe = "metalChocoboRecipe";
	public static final String SpellbinderRecipe = "spellbinderRecipe";
	public static final String DivineroseRecipe = "divineRoseRecipe";
	public static final String FairyharpRecipe = "fairyHarpRecipe";
	public static final String CrabclawRecipe = "crabClawRecipe";
	public static final String WishingstarRecipe = "wishingStarRecipe";
	public static final String PumpkinheadRecipe = "pumpkinHeadRecipe";
	public static final String ThreewishesRecipe = "threeWishesRecipe";
	public static final String JunglekingRecipe = "jungleKingRecipe";
	public static final String OlympiaRecipe = "olympiaRecipe";
	public static final String LadyluckRecipe = "ladyLuckRecipe";
	public static final String PeoplesheartsRecipe = "keybladeofPeoplesHeartsRecipe";
	public static final String UltimaweaponRecipe = "ultimaWeaponRecipe";
	public static final String TreasuretroveRecipe = "treasureTroveRecipe";
	public static final String StarseekerRecipe = "starSeekerRecipe";
	public static final String SouleaterRecipe = "soulEaterRecipe";
	public static final String StarlightRecipe = "starLightRecipe";
	public static final String RainfellRecipe = "rainFellRecipe";
	public static final String EarthshakerRecipe = "earthShakerRecipe";
	public static final String WaywardwindRecipe = "waywardWindRecipe";
	public static final String KingdomKeyRecipe = "kingdomKeyRecipe";

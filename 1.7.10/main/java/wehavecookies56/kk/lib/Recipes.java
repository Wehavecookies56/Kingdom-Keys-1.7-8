...
public class Recipes {
	...
	public static void initShapedRecipes(){
		...
		GameRegistry.addRecipe(new ItemStack(AddedItems.OrganizationHood), new Object[]{
			...
			"LOL",
			"SIS",
			'O', Blocks.soul_sand, 'L', AddedItems.DarkLeather, 'S', Items.string, 'I', blackDye
		});
		GameRegistry.addRecipe(new ItemStack(AddedItems.OrganizationCoat), new Object[]{
			"LIL",
			"LOL",
			"LLL",
			'O', Blocks.obsidian, 'L', AddedItems.DarkLeather, 'I', blackDye
		});
		...
		GameRegistry.addRecipe(new ItemStack(AddedBlocks.Synthesiser), new Object[]{
			...
			"H5N",
			"OHO",
			'M', AddedBlocks.MetalBlox, 'C', Blocks.crafting_table, 'H', AddedBlocks.HardBlox, '5', AddedItems.Munny500, 'N', AddedBlocks.NormalBlox, 'O', AddedItems.HP
		});
	}

...
public class ItemTwoBecomeOne extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemTwoBecomeOne(ToolMaterial kingdomkey012345) {
        super(kingdomkey012345);

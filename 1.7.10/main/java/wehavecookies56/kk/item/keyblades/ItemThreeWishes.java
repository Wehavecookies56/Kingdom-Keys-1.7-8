...
public class ItemThreeWishes extends ItemSword implements IBattlegearWeapon{
	public static boolean keyPressed = false;
	public static boolean keyHasBeenPressed = false;
    public ItemThreeWishes(ToolMaterial kingdomkey9876543) {
        super(kingdomkey9876543);
